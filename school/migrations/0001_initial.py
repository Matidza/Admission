# Generated by Django 5.1.2 on 2024-12-13 18:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.CharField(choices=[('Limpopo', 'Limpopo'), ('Free State', 'Free State'), ('Gauteng', 'Gauteng'), ('North West', 'North West'), ('KZN', 'KZN'), ('Mpumalanga', 'Mpumalanga'), ('Eastern Cape', 'Eastern Cape'), ('Northern Cape', 'Northern Cape'), ('Western Cape', 'Western Cape')], max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.CharField(blank=True, choices=[('Public', 'Public School'), ('Private', 'Private School')], max_length=200)),
                ('province', models.CharField(blank=True, choices=[('Limpopo', 'Limpopo'), ('Free State', 'Free State'), ('Gauteng', 'Gauteng'), ('North West', 'North West'), ('KZN', 'KZN'), ('Mpumalanga', 'Mpumalanga'), ('Eastern Cape', 'Eastern Cape'), ('Northern Cape', 'Northern Cape'), ('Western Cape', 'Western Cape')], max_length=50)),
                ...
                ('section_21', models.CharField(choices=[('Section 21 (Self Reliant)', 'Self Reliant: Yes'), ('Section 21 (Self Reliant)', 'Self Reliant: No')], max_length=100)),
                ('school_fees', models.CharField(max_length=100)),
                ('quintile_Level', models.CharField(choices=[('Quintile 1', 'Q1'), ('Quintile 2', 'Q2'), ('Quintile 3', 'Q3'), ('Quintile 4', 'Q4'), ('Quintile 5', 'Q5')], max_length=100)),
