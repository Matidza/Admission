# Generated by Django 5.1.2 on 2025-03-01 22:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provinc', models.CharField(choices=[('Limpopo', 'Limpopo'), ('Free State', 'Free State'), ('Gauteng', 'Gauteng'), ('North West', 'North West'), ('KwaZulu-Natal', 'KwaZulu-Natal'), ('Mpumalanga', 'Mpumalanga'), ('Eastern Cape', 'Eastern Cape'), ('Northern Cape', 'Northern Cape'), ('Western Cape', 'Western Cape')], max_length=50, null=True)),
                ...
                ('urban_rural', models.CharField(blank=True, choices=[('urban', 'urban'), ('rural', 'rural'), ('metropolitan', 'metropolitan')], max_length=100)),
                ...
                ('school_fees', models.CharField(choices=[('School Fees', 'Fees: Yes'), ('School Fees', 'Fees: No')], max_length=20)),
                ...
                ('history', models.CharField(blank=True, max_length=20000)),
                ('mission', models.CharField(blank=True, max_length=20000)),
                ('user', models.ForeignKey(blank=True, limit_choices_to={'profile__user_type': 'school'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='school_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(blank=True, max_length=10000)),
                ('image', models.ImageField(blank=True, default='', null=True, upload_to='uploads/academics/')),
